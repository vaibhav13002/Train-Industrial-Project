...
else if (Line_1_up_r_State == 1 && Line_1_up_g_State == 0 && Line_1_dn_r_State == 1 && Line_1_dn_g_State == 0 && signalCategory == 1)
{ Serial.println("4");
  if ( s0 == 1 && s1 == 1 && s2 == 1 && s3 == 1)
  { Serial.println("5");
...
//  timerAlarmWrite(My_timer_1, 15000, true);
...
void loop() {
  ...
  int signalStrength =(int)(modem.getSignalQuality());
  int dBmSignalStrength = -113 + 2 * signalStrength;
   Serial.println("test");

  Serial.println(dBmSignalStrength);
